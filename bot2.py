...
r = redis.Redis(host='95.217.10.252', port=6380, db=0)
def carregar_frases():
...
@app.route('/')
def index():
    instancia = os.environ.get("INSTANCE_NAME2")
...
#@login_required
def obter_qrcode():
    instancia = os.environ.get("INSTANCE_NAME2")  # Captura o parâmetro de consulta
